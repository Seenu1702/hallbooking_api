...
//     return [x+y, x-y];
//     return x+y, x-y;   its return only x-y value because "," having least precedure/priority
//     return x+y, x-y, x*y its return only x*y value because "," having least precedure/priority
// }

// // console.log(addSub(5, 6).join(' '));

// // let [addResult, subResult] = addSub(5, 6);    destructioring 
// console.log(addResult);
// confirm.log(subResult);
...
// anonymous fn will not support hoisting but non-anonymous fn will support hoisting
...
// (function (name) {
//     console.log('hi', name);
// }) will act as function name and ('sathish') will be the function calling
